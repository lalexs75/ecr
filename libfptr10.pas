...
type
  ...
  Tlibfptr_marking_code_type_1_2 = libfptr_marking_code_type_1_2;

  libfptr_marking_estimated_status = (
  ...
  Tlibfptr_item_units = libfptr_item_units;

  libfptr_mark_operator_item_status = (
       LIBFPTR_OIS_ESTIMATED_STATUS_CORRECT = 1,
       LIBFPTR_OIS_ESTIMATED_STATUS_INCORRECT,
       LIBFPTR_OIS_SALE_STOPPED
  );
  Tlibfptr_mark_operator_item_status = libfptr_mark_operator_item_status;

  libfptr_mark_operator_response_result = (
       LIBFPTR_ORR_CORRECT = 0,
       LIBFPTR_ORR_INCORRECT,
       LIBFPTR_ORR_UNRECOGNIZED
  );
  Tlibfptr_mark_operator_response_result = libfptr_mark_operator_response_result;

  libfptr_fn_check_error_reason = (
  ...
  Tlibfptr_fn_check_error_reason = libfptr_fn_check_error_reason;
  ...
  libfptr_marking_mode_checking_status = (
       LIBFPTR_MCS_BLOCK = 0,
  ...
  Tlibfptr_marking_mode_checking_status = libfptr_marking_mode_checking_status;

  libfptr_notice_free_memory = (
  ...
  Tlibfptr_document_type = libfptr_document_type;

  libfptr_mark_checking_status_in_cash = (
       LIBFPTR_MCS_NOT_EXECUTED = 0,
       LIBFPTR_MCS_EXECUTED,
       LIBFPTR_MCS_IS_OVER,
       LIBFPTR_MCS_RESULT_IS_RECIEVED
  );
  Tlibfptr_mark_checking_status_in_cash = libfptr_mark_checking_status_in_cash;

  libfptr_mark_checking_type_in_cash = (
  ...
  libfptr_mark_checking_stage_in_cash = (
